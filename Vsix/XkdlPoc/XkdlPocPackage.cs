...
namespace XkdlPoc
{
	...
	[ProvideUIContextRule(PackageGuids.CommandVisisiblityString,
		name: "GenOne files",
		expression: "IsXkdl",
		termNames: new[] { "IsXkdl" },
		termValues: new[] { "HierSingleSelectionName:.xkdl" })]
	public sealed class XkdlPocPackage : AsyncPackage
	{
		/// <summary>
		/// XkdlPocPackage GUID string.
		/// </summary>
		public const string PackageGuidString = "81793813-05f4-4eb2-803d-568d563fab9a";
